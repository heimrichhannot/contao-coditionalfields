 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_form_field']['cond'] = array('Anzeige abhängig von', 'Legen Sie fest, welchen Feld die Anzeige dieses Elementes steuert.');

/**
 * Legends
 */
$GLOBALS['TL_LANG']['tl_form_field']['condition_legend'] = 'Abhängigkeiten';
