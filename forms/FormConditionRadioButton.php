...
class FormConditionRadioButton extends \FormRadioButton
{
	 ...
	 * @var string
	 */
	protected $strTemplate = 'form_condition_radio';
	...
	public function generate()
	{
		...
		{
			$strOptions .= sprintf('<span><input type="radio" name="%s" onclick="this.form.submit();" id="opt_%s" class="radio" value="%s"%s%s%s <label id="lbl_%s" for="opt_%s">%s</label></span> ',
					$this->strName,
					$this->strId.'_'.$i,
					$arrOption['value'],
